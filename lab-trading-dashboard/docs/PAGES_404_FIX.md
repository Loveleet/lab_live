...
The workflow now deploys to the **gh-pages** branch (no "github-pages" environment needed). After the first successful run, set **Settings → Pages** → Source: **Deploy from a branch** → Branch: **gh-pages**, Folder: **/ (root)**. Then open https://loveleet.github.io/lab_anish/
...
2. If it’s **green** → wait 1–2 minutes, then open:  
   **https://loveleet.github.io/lab_anish/**
...
| 4 | Open **https://loveleet.github.io/lab_anish/**. |
