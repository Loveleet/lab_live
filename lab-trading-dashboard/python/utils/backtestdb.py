...
# Set DATABASE_URL_BACKTEST or DATABASE_URL, or DB_HOST, DB_USER, DB_PASSWORD, DB_NAME
import os as _os
def _backtest_pg_url():
    u = _os.environ.get("DATABASE_URL_BACKTEST") or _os.environ.get("DATABASE_URL")
    if u:
        return u
    ...
    return f"postgresql://{user}:{pwd}@{h}:{p}/backtestdb"
connection_string_postgresql = _backtest_pg_url()
